    ...
    <React.Fragment>
      <Grid container spacing={3} wrap="nowrap">
        <Grid item xs={4} className={`${classes.center} category__hover`} >
          <img src={imageCategory1} alt={imageCategory1} className="category__img" />
          <h2 className="category__title">Table Tree Plant</h2>
          <p className="category__count">(50 Items)</p>
        </Grid>
        <Grid item xs={4} className="category__item" className={`${classes.center} category__hover`}>
          <img src={imageCategory2} alt={imageCategory2} className="category__img" />
          <h2 className="category__title">Table Tree Plant</h2>
          <p className="category__count">(50 Items)</p>
        </Grid>
        <Grid item xs={4} className="category__item" className={`${classes.center} category__hover`}>
          <img src={imageCategory3} alt={imageCategory3} className="category__img" />
          <h2 className="category__title">Table Tree Plant</h2>
          <p className="category__count">(50 Items)</p>
        </Grid>
      </Grid>
