  ...
  return (
    <div className="story">
      ...
      <p className="story__desc">
        ...
        All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as <br />
      ...
      <p className="story__name">NGOC HOANG and THONG SEO - <span>Web design</span></p>
    </div>
  )
}
